...
let throttle = function (fn, delay) { //eslint-disable-line
    ...
    doBind = function () { // bind once
        ...
        directive.swipeEventTarget.addEventListener('touchstart', directive.startListener);
        directive.swipeEventTarget.addEventListener('touchmove', directive.movingListener);
        directive.swipeEventTarget.addEventListener('touchend', directive.endListener);
    },
